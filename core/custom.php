	...
	function cpotheme_custom_form( $option_name, $option_list ) {
		...
		<div class="wrap">
			<div class="cpothemes-version">
				<span><?php printf( __( 'Version %s', 'antreas' ), CPOTHEME_VERSION ); ?></span>
				<span><?php printf( __( 'Core %s', 'antreas' ), CPOCORE_VERSION ); ?></span>
				<span><a href="http://cpothemes.com/documentation?utm_source=theme%20settings&utm_medium=options&utm_campaign=themes" target="_blank"><?php _e( 'Help', 'antreas' ); ?></a></span>
			</div>
			...
			<div id="message" class="updated">
				<p><strong><?php _e( 'Changes have been saved.', 'antreas' ); ?></strong></p>
			</div>
			<?php endif; ?>
			<?php if ( isset( $_GET['error'] ) ) : ?>
			<div id="message" class="error">
				<p><strong><?php _e( 'Changes could not be saved.', 'antreas' ); ?></strong></p>
			</div>
			<?php endif; ?> 
	...
	function cpotheme_custom_nav( $options ) {
		...
		foreach ( $field_list as $current_field ) {
			if ( $current_field['type'] == 'separator' ) {
				...
				if ( $current_tab == $field_id || ( $current_tab == '' && $nav_count == 0 ) ) {
					$output .= ' active';
				}
		...
		//$output .= '<a href="http://www.cpothemes.com/support">'.__('Support', 'antreas').'</a>';
		$output .= '</div>';
		echo $output;
	}
}
...
if ( ! function_exists( 'cpotheme_custom_save' ) ) {
	function cpotheme_custom_save( $option_name, $option_fields ) {
		...
		if ( isset( $_POST['cpotheme_custom_action'] ) && $_POST['cpotheme_custom_action'] == $option_name ) {
			if ( ! wp_verify_nonce( $_POST['_wpnonce'], 'cpotheme_nonce' ) ) {
	...
	function cpotheme_custom_header() {
		...
		<div class="cpothemes-header">
			...
			<div class="cpothemes-header-meta">
				<a target="_blank" href="http://www.cpothemes.com/support"><?php _e( 'Theme Documentation', 'antreas' ); ?></a>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a target="_blank" href="http://themeforest.net/user/cpothemes?ref=cpothemes"><?php _e( 'More Themes', 'antreas' ); ?></a>
			</div>
		</div>
...
if ( ! function_exists( 'cpotheme_custom_support' ) ) {
	function cpotheme_custom_support() {
		...
		$output .= '<a target="_blank" href="http://www.cpothemes.com/documentation">' . __( 'Theme Documentation', 'antreas' ) . '</a>';
		$output .= '&nbsp;&nbsp;|&nbsp;&nbsp;';
		$output .= '<a target="_blank" href="http://www.cpothemes.com/forums">' . __( 'Support Forum', 'antreas' ) . '</a>';
		$output .= '</div>';
		return $output;
	}
}
	...
	function cpotheme_custom_header_old() {
		...
		<div class="cpotheme-header">
			...
			<div class="header-meta">
				<a target="_blank" href="http://www.cpothemes.com/support"><?php _e( 'Theme Documentation', 'antreas' ); ?></a>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a target="_blank" href="http://www.cpothemes.com/forums"><?php _e( 'Support Forums', 'antreas' ); ?></a>
				&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
				<a target="_blank" href="http://www.cpothemes.com/themes"><?php _e( 'More Themes', 'antreas' ); ?></a>
			</div>
		</div>
