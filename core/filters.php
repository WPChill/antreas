...
if ( ! function_exists( 'cpotheme_thumbnail_settings' ) ) {
	function cpotheme_thumbnail_settings() {
		...
		$default_values = array(
			'width'  => CPOTHEME_THUMBNAIL_WIDTH,
			'height' => CPOTHEME_THUMBNAIL_HEIGHT,
		);
		$data           = shortcode_atts( $default_values, $option_values );
		register_setting( 'media', 'cpotheme_thumbnail' );
		add_settings_field( 'cpotheme_portfolio_thumbnails', __( 'Portfolio Size', 'antreas' ), 'cpotheme_thumbnail_fields', 'media', 'default', $data );
	}
}
