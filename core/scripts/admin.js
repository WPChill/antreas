jQuery(document).ready(function () {
    ...
    /* COLOR PICKER FIELD */
    jQuery('.cpo-color-selector').each(function () {
	...
	/* RANGE CONTROL */
	jQuery('.cpotheme-range-control').each(function(){

		var input = jQuery(this).find('input');
		var slider = jQuery(this).find('.slider');
		var sliderMinValue = parseFloat(slider.attr('slider-min-value'));
		var sliderMaxValue = parseFloat(slider.attr('slider-max-value'));
		var sliderStepValue = parseFloat(slider.attr('slider-step-value'));
