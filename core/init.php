...
if ( ! function_exists( 'antreas_add_styles' ) ) {
	...
	function antreas_add_styles() {
		...
		wp_register_style( 'antreas-fontawesome', ANTREAS_ASSETS_CSS . 'all.css', array(), ANTREAS_VERSION );
        wp_register_style( 'antreas-fontawesome-old', ANTREAS_ASSETS_CSS . 'icon-fontawesome.css', array(), ANTREAS_VERSION );
...
if ( ! function_exists( 'antreas_add_admin_styles' ) ) {
	...
	function antreas_add_admin_styles() {
		...
		if ( 'post' == isset( $screen->base ) && $screen->base ) {
			...
			wp_enqueue_style( 'antreas-fontawesome', ANTREAS_ASSETS_CSS . 'all.css', array(), ANTREAS_VERSION );
            wp_enqueue_style( 'antreas-fontawesome-old', ANTREAS_ASSETS_CSS . 'icon-fontawesome.css', array(), ANTREAS_VERSION );
		}
